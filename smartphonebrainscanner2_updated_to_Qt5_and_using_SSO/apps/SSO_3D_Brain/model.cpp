...
Model::Model(QOpenGLShaderProgram *m_program, QString filename)
{
...
void Model::initialize()
{
    ...
    setFragmentShaderFile(QString(":/fshader.normals.glsl"));
    setVertexShaderFile(QString(":/vshader.normals.glsl"));
    linkShaderProgram();
    initShaderProgram();
}
...
bool Model::setFragmentShaderFile(QString filename)
{
    ...
    QOpenGLShader* shaderF = new QOpenGLShader(QOpenGLShader::Fragment);
...
bool Model::setVertexShaderFile(QString filename)
{
    ...
    QOpenGLShader* shaderV = new QOpenGLShader(QOpenGLShader::Vertex);
