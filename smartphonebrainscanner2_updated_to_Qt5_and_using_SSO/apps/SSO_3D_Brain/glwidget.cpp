    ...
    timer(new QBasicTimer)
{
    ...
    qDebug()<<Sbs2Common::getRootAppPath() + QString("vertface_brain_reduced.obj");
}
...
void GLWidget::initialize()
{
    ...
    model = new Model(m_program, Sbs2Common::getRootAppPath() + QString("vertface_brain_reduced.obj"));
